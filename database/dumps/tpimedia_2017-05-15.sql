...
# Temps de génération: 2017-05-15 12:38:22 +0000
# ************************************************************
...
INSERT INTO `comments` (`id`, `content`, `created_at`, `updated_at`, `user_id`, `post_id`)
VALUES
	(1,'Ca risque d\'être une soirée rythmée !','2017-05-15 09:14:49','2017-05-15 09:14:49',8,1),
	(2,'Je serais la !','2017-05-15 10:08:43','2017-05-15 10:08:43',8,1),
	(3,'Ces commentaires fonctionnent a merveille !','2017-05-15 10:10:02','2017-05-15 10:10:02',8,1),
	(4,'Les commentaires se rechargent correctement !','2017-05-15 11:08:19','2017-05-15 11:08:19',8,1),
	(5,'Les commentaires se rechargent correctement !','2017-05-15 11:09:39','2017-05-15 11:09:39',8,1),
	(6,'Les commentaires se rechargent correctement !','2017-05-15 11:10:25','2017-05-15 11:10:25',8,1),
	(7,'Un dernier petit test','2017-05-15 11:11:09','2017-05-15 11:11:09',8,1),
	(8,'Le rechargement fonctionne-il ?','2017-05-15 11:13:21','2017-05-15 11:13:21',8,1),
	(9,'Je suis la !','2017-05-15 11:21:45','2017-05-15 11:21:45',12,1),
	(10,'Je suis la !','2017-05-15 11:23:58','2017-05-15 11:23:58',12,1),
	(11,'Je suis la !','2017-05-15 11:34:37','2017-05-15 11:34:37',12,1),
	(12,'Je suis la !','2017-05-15 11:35:30','2017-05-15 11:35:30',12,1),
	(13,'Aie, il y a un bug lors de la soumission de commentaire !','2017-05-15 11:38:23','2017-05-15 11:38:23',12,1),
	(14,'Aie, il y a un bug lors de la soumission de commentaire !','2017-05-15 11:40:41','2017-05-15 11:40:41',12,1),
	(15,'Salut !','2017-05-15 11:41:13','2017-05-15 11:41:13',12,1),
	(16,'Salut !','2017-05-15 11:45:45','2017-05-15 11:45:45',12,1),
	(17,'Salut !','2017-05-15 11:45:59','2017-05-15 11:45:59',12,1),
	(18,'Salut !','2017-05-15 11:46:39','2017-05-15 11:46:39',12,1),
	(19,'Quel super style de danse !','2017-05-15 11:47:47','2017-05-15 11:47:47',12,12),
	(20,'Tutu','2017-05-15 12:31:57','2017-05-15 12:31:57',10,12),
	(21,'Yeahh je danse comme une bombe !','2017-05-15 12:33:46','2017-05-15 12:33:46',13,12);
...
INSERT INTO `posts` (`id`, `title`, `slug`, `date`, `hat`, `content`, `online`, `created_at`, `updated_at`, `user_id`, `poster_id`)
VALUES
	(1,'Soirée Djembé','soiree-djembe','2017-05-24 00:00:00','Rejoignez-nous le mercredi 24 mai pour une soirée exclusive de Djembé. En compagnie d\'un invité special.','Un Djembé est un instrument de percussion africain composé d\'un fût de bois en forme de calice sur lequel est montée une peau de chèvre ou d\'antilope. Il offre un son rond est puissant.\nVenez découvrir tous ces états lors de notre soirée exclusive. Nous serons accompagnés de plusieurs musiciens de talents, qui nous interpréterons plusieurs titres revisités au Djembé.',1,'2017-05-14 18:55:26','2017-05-14 18:55:26',8,2),
...
VALUES
	...
	(8,'VANVAN','van@van.van','$2y$10$lD.TkdtttJxiYXr1QSWObe2GpR2ExcaV7eYof7WDaoUK1UOjmTl2a','ly3WezCuhP81kD4xEWVDi6kRgCtl31EO8HWsxA1IKT3CorrHVgG6mRFAEUx3','2017-05-12 14:43:46','2017-05-14 10:47:21','/ressources/profilephotos/VANVAN.jpg',2),
